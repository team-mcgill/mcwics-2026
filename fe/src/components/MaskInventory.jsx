                ...
                >
                  ...
                  <div className="p-3">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-white text-xs font-medium truncate">{design.name}</h3>
                      <span className="text-[#555] text-[10px] font-light">{formatDate(design.createdAt)}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 px-3 py-2 text-[11px] font-light tracking-wider uppercase bg-transparent border border-[#333] hover:border-[#d4af37]/50 text-[#a0a0a0] hover:text-white rounded-lg transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                      >
                        Load
                      </button>
                      ...
                      {isListed ? (
                        <button
                          ...
                          className="flex-1 px-3 py-2 text-[11px] font-light tracking-wider uppercase bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-200 border border-emerald-500/30 hover:border-emerald-500/50 rounded-lg transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                          {isListingPending ? '...' : 'Unlist'}
                        </button>
                      ) : (
                        <button
                          onClick={() => handleSellClick(design)}
                          disabled={design.pending || !design.mintAddress}
                          className="flex-1 px-3 py-2 text-[11px] font-light tracking-wider uppercase bg-[#d4af37]/10 hover:bg-[#d4af37]/20 text-[#d4af37] border border-[#d4af37]/30 hover:border-[#d4af37]/50 rounded-lg transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                          Sell
                        </button>
                      )}
                      ...
                      <div className="flex items-center gap-1 ml-1">
                        {!design.pending && design.mintAddress ? (
                          <a
                            ...
                            className="p-2 text-[#555] hover:text-[#d4af37] hover:bg-[#d4af37]/10 rounded-lg transition-all duration-200"
                          >
                        ...
                        <button
                          ...
                          title="Delete design"
                          className="p-2 text-[#555] hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:text-[#555] disabled:hover:bg-transparent"
                        >
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
